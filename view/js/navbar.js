...
navbar='<nav class="navbar navbar-light navbar-expand-md bg-faded justify-content-center navbar fixed-top">\
    <a href="index1.php" class="navbar-brand d-flex w-50 mr-auto">就業通</a>\
    ...
    <div class="navbar-collapse collapse w-100" id="collapsingNavbar3">\
        <ul class="navbar-nav w-100 justify-content-center">\
            <li class="nav-item">\
                <a class="nav-link" href="field.php">學門</a>\
            </li>\
            <li class="nav-item">\
                <a class="nav-link" href="CareerType.php">職缺</a>\
            </li>\
            \
        </ul>\
        <ul class="nav navbar-nav ml-auto w-100 justify-content-end">\
             ...
             <li class="nav-item">\
                <a class="nav-link" href="revise.php">會員</a>\
            </li>\
            <li class="nav-item">\
                <form method="post" action="../controllers/MemberController.php">\
                <input type="hidden" name="action" value="logout">\
               <button type="submit" class="nav-link" style="background-color: #000281; color:white; border-color: #000281;">登出</button>\
            </form>\
            \
            <!-- <li class="nav-item">\
